...
function VerletProgram(){
    ...
    this.displayMetaballs = function(){
         // return;
    ...
    this.updateOld = function(){
        ...
        gl.activeTexture(gl.TEXTURE0);
        gl.bindTexture(gl.TEXTURE_2D, this.ballTexture.textureOriginal.texture);
    ...
    this.update = function(){
        ...
        var tmp = this.ballTexture.texture3;
        var tmp2 = this.ballTexture.textureOriginal;

        this.ballTexture.textureOriginal = this.ballTexture.texture ;


        this.ballTexture.texture3 = tmp2;
        this.ballTexture.texture = tmp;
    ...
    var ballTexture = function(size){
        ...
        this.texture4 = createRenderTarget(this.width, this.height, data);        
         this.textureOriginal = createRenderTarget(this.width, this.height, data);        
